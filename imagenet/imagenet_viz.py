...
if args.imgs:
    ...
    for ii in range(8):
        for jj in range(12):
            if jj == 0:
                ...
                row = np.concatenate((row, img0[ii * 12 + jj]), axis=1)
    ...
    img1 = img1[0]
    img1 = np.reshape(img1, (27, 27, 256))
    ...
    for ii in range(16):
        for jj in range(16):
            if jj == 0:
                ...
                row = np.concatenate((row, img1[ii * 16 + jj]), axis=1)
    ...
    img3 = img3[0]
    img3 = np.reshape(img3, (13, 13, 384))
    ...
    for ii in range(16):
        for jj in range(24):
            if jj == 0:
                ...
                row = np.concatenate((row, img3[ii * 24 + jj]), axis=1)
    ...
    for ii in range(16):
        for jj in range(16):
            if jj == 0:
                ...
                row = np.concatenate((row, img4[ii * 16 + jj]), axis=1)
