...
for ii in range(250):
    ...
    B = np.load("../results/random_feedback/dfa/B_" + str(ii+1) + "_0.npy")
    shape = np.shape(B)
    if shape[0] < shape[1]:
        B = np.transpose(B)
    B = np.reshape(B, (-1))
    
    W2_ii_0 = np.load("../results/random_feedback/dfa/W2_" + str(ii+1) + "_0.npy")
    ...
    acc = np.load("../results/random_feedback/dfa/acc_" + str(ii+1) + "_0.npy")
...
for ii in range(250):  
    ...
    B = np.load("../results/random_feedback/dfa1/B_" + str(ii+1) + "_1.npy")
    shape = np.shape(B)
    if shape[0] < shape[1]:
        B = np.transpose(B)
    B = np.reshape(B, (-1))

    W2_ii_0 = np.load("../results/random_feedback/dfa1/W2_" + str(ii+1) + "_1.npy")
    W2_ii_0 = W2_ii_0[0:100]
    W2_ii_0 = np.reshape(W2_ii_0, (-1, 1))
    ...
    acc = np.load("../results/random_feedback/dfa1/acc_" + str(ii+1) + "_1.npy")
...
for ii in range(250):
    ...
    W2_ii_0 = np.load("../results/random_feedback/sparse_dfa/W2_" + str(ii+1) + "_2.npy")
    W2_ii_0 = W2_ii_0[0:100]
    W2_ii_0 = np.reshape(W2_ii_0, (-1, 1))
...
for ii in range(250):  
    ...
    B = np.load("../results/random_feedback/sparse_dfa1/B_" + str(ii+1) + "_3.npy")
    shape = np.shape(B)
    if shape[0] < shape[1]:
        B = np.transpose(B)
    B = np.reshape(B, (-1))

    W2_ii_0 = np.load("../results/random_feedback/sparse_dfa1/W2_" + str(ii+1) + "_3.npy")
    W2_ii_0 = W2_ii_0[0:100]
    W2_ii_0 = np.reshape(W2_ii_0, (-1, 1))
    ...
    acc = np.load("../results/random_feedback/sparse_dfa1/acc_" + str(ii+1) + "_3.npy")
