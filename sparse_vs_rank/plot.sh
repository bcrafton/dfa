...
python plot4.py --benchmark cifar10_1 --itrs 10 --x sparse --y angle --color_key acc --fix_key rank --fix_val 5
python plot4.py --benchmark cifar10_1 --itrs 10 --x sparse --y angle --color_key acc --fix_key rank --fix_val 10
python plot4.py --benchmark cifar10_1 --itrs 10 --fix_key rank --fix_val 5  --x sparse --y acc
python plot4.py --benchmark cifar10_1 --itrs 10 --fix_key rank --fix_val 10 --x sparse --y acc
python plot4.py --benchmark cifar10_1 --itrs 10 --fix_key rank --fix_val 5  --x sparse --y angle
