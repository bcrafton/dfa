...
l0 = LocallyConnected(input_size=[batch_size, 32, 32, 3], filter_size=[5, 5, 3, 96], num_classes=10, init=args.init, strides=[1, 1], padding="same", alpha=learning_rate, activation=Tanh(), bias=bias, last_layer=False, name='conv1', load=weights_conv, train=train_conv)
l1 = MaxPool(size=[batch_size, 32, 32, 96], ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding="SAME")

l2 = LocallyConnected(input_size=[batch_size, 16, 16, 96], filter_size=[5, 5, 96, 128], num_classes=10, init=args.init, strides=[1, 1], padding="same", alpha=learning_rate, activation=Tanh(), bias=bias, last_layer=False, name='conv2', load=weights_conv, train=train_conv)
l3 = MaxPool(size=[batch_size, 16, 16, 128], ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding="SAME")

l4 = LocallyConnected(input_size=[batch_size, 8, 8, 128], filter_size=[5, 5, 128, 256], num_classes=10, init=args.init, strides=[1, 1], padding="same", alpha=learning_rate, activation=Tanh(), bias=bias, last_layer=False, name='conv3', load=weights_conv, train=train_conv)
