...
# python imagenet_vgg1.py --epochs 100 --batch_size 32 --alpha 0.005 --decay 0.9 --gpu 0 --dfa 1 --sparse 1 --rank 0 --init zero --opt adam  --save 1 --name imagenet_vgg_sparse_adam  > vgg_sparse_results_adam  &
