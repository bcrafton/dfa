...
l0 = FullyConnected(size=[3072, 1000], num_classes=100, init_weights=args.init, alpha=ALPHA, activation=Tanh(), bias=0.0, last_layer=False)
l1 = FeedbackFC(size=[3072, 1000], num_classes=100, sparse=sparse, rank=rank)

l2 = FullyConnected(size=[1000, 1000], num_classes=100, init_weights=args.init, alpha=ALPHA, activation=Tanh(), bias=0.0, last_layer=False)
l3 = FeedbackFC(size=[1000, 1000], num_classes=100, sparse=sparse, rank=rank)

l4 = FullyConnected(size=[1000, 1000], num_classes=100, init_weights=args.init, alpha=ALPHA, activation=Tanh(), bias=0.0, last_layer=False)
l5 = FeedbackFC(size=[1000, 1000], num_classes=100, sparse=sparse, rank=rank)

l6 = FullyConnected(size=[1000, 100], num_classes=100, init_weights=args.init, alpha=ALPHA, activation=Linear(), bias=0.0, last_layer=True)
