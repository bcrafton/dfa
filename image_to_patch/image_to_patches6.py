...
_filters1 = np.random.uniform(low=1.0, high=1.0, size=(1, 5625, 3, 3, 3, 64))
_filters2 = np.random.uniform(low=1.0, high=1.0, size=(1, 625, 3, 3, 64, 128))
_z, _z2 = sess.run([z, z2], feed_dict={image: _image, filters1: _filters1, filters2: _filters2})

plt.imshow(_z2[0, :, :, 0] / np.max(_z2[0, :, :, 0]))
plt.show()
