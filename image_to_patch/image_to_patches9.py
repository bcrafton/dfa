...
slice2 = tf.slice(pad, begin=[0, 0, 1, 0], size=[1, 224, 224, 3])
slice3 = tf.slice(pad, begin=[0, 0, 2, 0], size=[1, 224, 224, 3])
slices1 = tf.concat((slice1, slice2, slice3), axis=2)

slice4 = tf.slice(pad, begin=[0, 1, 0, 0], size=[1, 224, 224, 3])
slice5 = tf.slice(pad, begin=[0, 1, 1, 0], size=[1, 224, 224, 3])
slice6 = tf.slice(pad, begin=[0, 1, 2, 0], size=[1, 224, 224, 3])
slices2 = tf.concat((slice4, slice5, slice6), axis=2)

slice7 = tf.slice(pad, begin=[0, 2, 0, 0], size=[1, 224, 224, 3])
slice8 = tf.slice(pad, begin=[0, 2, 1, 0], size=[1, 224, 224, 3])
slice9 = tf.slice(pad, begin=[0, 2, 2, 0], size=[1, 224, 224, 3])
